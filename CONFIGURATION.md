...
Global display preferences live in **`display_config.json`** at the solar-monitoring project root, editable from the web dashboard **Settings → ESP32 display**.
...
| `layout`, `theme`, `grid_alert`, `use_host` | Appearance |
